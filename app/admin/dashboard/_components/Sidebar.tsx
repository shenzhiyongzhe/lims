...
const NAV_ITEMS: NavItem[] = [
  { href: "/admin/dashboard/users", label: "管理员用户管理", icon: "🏠" },
  { href: "/admin/dashboard/customers", label: "贷款用户管理", icon: "🏠" },
  {
  ...
  {
    href: "/admin/dashboard/risk_controller",
    label: "风控人页面",
    icon: "🏠",
    roles: ["风控人"],
  },
  {
    href: "/admin/dashboard/collector",
    label: "负责人页面",
    icon: "🏠",
    roles: ["负责人"],
  },
  ...
  {
    href: "/admin/dashboard/payee",
    label: "收款人页面",
    icon: "🏠",
    roles: ["收款人"],
  },
  {
    href: "/admin/dashboard/payee/qrcode",
    label: "添加收款码",
    icon: "🏠",
    roles: ["收款人"],
  },
