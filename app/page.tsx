      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <Link href="/login/admin" className="group">
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 border border-gray-200 hover:border-blue-300">
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">支付管理</h4>
              <p className="text-gray-600 text-sm">管理支付订单和交易记录</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">查看支付统计和业务分析</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">配置支付参数和系统选项</p>
            </div>
          </div>
        </div>
      </div>
